...
const AWARDS = [
  {
    ...
    caption:
      "Front elevation, evening — limewash, standing-seam metal, mature hornbeam.",
  },
  {
    ...
    caption:
      "Plaster range hood, hand-glazed zellige, reclaimed Douglas fir island.",
  },
];
    ...
    <div style={{ background: "var(--bg)", color: "var(--ink)" }}>
      ...
      >
        ...
        >
          <div
            className="micro-sm"
            style={{ opacity: 0.7, letterSpacing: "0.26em" }}
          >
            Vol. I · No. 04
          </div>
          <div
        ...
        >
          ...
          >
            A small studio, quietly recognised — a record of the awards,
            articles, and conversations the work has been part of.
          </p>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              Laurel Leaf Design Studio was honoured at the{" "}
              <em style={{ fontWeight: 300 }}>Stellar Awards</em> with two
              recognitions in the Custom Built Spec Home category —{" "}
              <em style={{ fontWeight: 300 }}>Best Curb Appeal</em> and{" "}
            ...
            >
              The awards recognise homes built on speculation that nonetheless
              arrive with the considered detail of a bespoke commission. Both
              honours were given for a single project — a four-bedroom new
              build completed late last year, photographed below.
            </p>
          </div>
        </div>
      </section>
          ...
          {AWARDS.map((a) => (
            ...
            >
              ...
              >
                ...
                <div
                  className="micro-sm"
                  style={{ opacity: 0.6, letterSpacing: "0.24em" }}
                >
      ...
      >
        ...
        >
          <div>
            <div
              className="micro"
              style={{ opacity: 0.55, marginBottom: 22 }}
            >
          ...
          >
            A small selection from the project&apos;s editorial photography.
            Full case study coming to the journal this autumn.
          </p>
        </div>
        <div
          style={{
      ...
      >
        ...
        >
          <div style={{ position: "relative" }}>
            <div
              style={{
                aspectRatio: "3/4",
                background:
                  "linear-gradient(165deg, #d8cfbf 0%, #b8ad97 60%, #968a72 100%)",
                position: "relative",
                overflow: "hidden",
                boxShadow:
                  "0 30px 60px -20px rgba(42,46,37,0.35), 0 8px 20px -8px rgba(42,46,37,0.25)",
              }}
            >
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "repeating-linear-gradient(90deg, transparent 0 60px, rgba(42,46,37,0.025) 60px 61px)",
                }}
              />
              <div
                style={{
              ...
              >
                ...
                <div
                  className="micro-sm"
                  style={{ opacity: 0.7, letterSpacing: "0.22em" }}
                >
                  ISSUE TBC
                </div>
              </div>
          ...
          <div>
            ...
            >
              An <em style={{ fontWeight: 300 }}>upcoming feature</em> with a
              national interiors title.
            </h2>
            <p
              style={{
                fontSize: 17,
            ...
            >
              Details, cover artwork, and the full editorial spread will be
              added here once embargo lifts. The piece focuses on the
              studio&apos;s approach to spec homes that read as bespoke — and
              how restraint, rather than flourish, carried both award-winning
              rooms.
            </p>
            <ul
              style={{
